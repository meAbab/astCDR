...
<option <?php if (empty($_REQUEST['disposition']) || $_REQUEST['disposition'] == 'ANSWERED') { echo 'selected="selected"'; } ?> value="ANSWERED">Answered</option>
...
<option <?php if (isset($_REQUEST['disposition']) && $_REQUEST['disposition'] == 'all') { echo 'selected="selected"'; } ?> value="all">All Dispositions</option>
</select>
</td>
</tr>
<tr>
